...
import de.snenjih.velocloud.agent.runtime.local.terminal.commands.impl.ClearCommand
import de.snenjih.velocloud.agent.runtime.local.terminal.screen.ServiceScreenController
import de.snenjih.velocloud.agent.runtime.local.terminal.setup.SetupController
...
class JLine3Terminal {
    ...
    fun resetPrompt() {
        this.updatePrompt("&bvelocloud&8@&7" + velocloudVersion() + " &8» &7")
    }
