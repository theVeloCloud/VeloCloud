...
import de.snenjih.velocloud.common.VelocloudUrl;
...
public class UpdaterRuntime {
    ...
    private static final String DEFAULT_VERSION = System.getenv("VELOCLOUD_VERSION");
    private static final String LAUNCHER_JAR = "velocloud-launcher.jar";
    ...
    public static void main(String[] args) {
        ...
        var downloadUrl = VelocloudUrl.GITHUB_ORGA + "velocloud/releases/download/" + version + "/" + LAUNCHER_JAR;
